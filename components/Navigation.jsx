  ...
  return (
    <nav className={`sticky top-0 z-50 transition-all duration-300`}>
      <div className="max-w-7xl mx-auto px-4 flex gap-18 justify-between items-center">
        ...
        {/* links */}
        <div
          className={`hidden lg:flex items-center gap-4 sticky top-6 z-50 mx-auto w-fit px-10 py-4 rounded-full transition-all duration-500 ${isScrolled ? "bg-gray-100 backdrop-blur-xl border border-white/30 shadow-xl" : "bg-white/10 backdrop-blur-md border border-white/20"}`}
        >
          <Link
            href="#home"
