export const testimonials = [
  ...
  {
    name: "Patricia Lee",
    condition: "Patient with pulmonary hypertension",
    doctor: "Dr. Paresh C. Giri",
    text: "From the moment I walked in, I felt welcomed and cared for. The staff is professional yet warm, and Dr. Giri has given me tools to better control my pulmonary hypertension.",
    rating: 5,
  },
  {
    name: "David Thompson",
    condition: "Patient undergoing sleep study",
  ...
  },
  {
    ...
    condition: "Patient undergoing pulmonary testing",
